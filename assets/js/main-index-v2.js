...
function initMain() {
    ...
    if (!heroContainer || !mainContent) {
        console.warn('[Main] Elementos não encontrados no DOM, aguardando...');
...
// Auto-inicializar quando o DOM estiver pronto (fallback se MainInit não for chamado)
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', function() {
        // Aguardar um tick para garantir que todos os scripts carregaram
        setTimeout(function() {
