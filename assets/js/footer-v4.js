...
(function() {
    ...
    function setupEventListeners() {
        ...
        document.addEventListener('click', function(e) {
            ...
            if (btnId === 'cookie-accept-all' || btnId === 'cookie-accept-all-modal') {
                saveConsent('all');
                e.preventDefault();
                return;
            }
            ...
            if (btnId === 'cookie-reject-essentials') {
                saveConsent('reject');
                e.preventDefault();
                return;
            }
    ...
    window.addEventListener('Module:footer-v2-container:Ready', initFooter);
