...
(function() {
    ...
    function initClickAnimations() {
        ...
        const mobileSearchBtn = getElement('mobile-search-toggle');
        if (mobileSearchBtn) {
    ...
    // ============================================
    // Wrapper para compatibilidade com a chamada window.HeaderInit() do index.html
    window.HeaderInit = function() {
        console.log('[HeaderInit] Chamado (wrapper para HeaderModule.init)');
        if (window.HeaderModule && typeof window.HeaderModule.init === 'function') {
