...
class HeaderEngine {
  ...
  init() {
    ...
    // CORREÇÃO: Limpeza de estado inicial - garante que todos os painéis estão fechados
...
window.addEventListener('TemplateEngine:header:Ready', function() {
  if (!headerEngine.initialized) {
    console.log('[HeaderEngine] TemplateEngine:header:Ready - iniciando HeaderEngine');
    headerEngine.init();
  } else {
